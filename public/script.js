...
const apiData = {
    ...
    "AI": [
        ...
        { 
            ...
            title: "Qwenai-32b", 
            status: "online", 
            description: "API untuk mengakses model Qwenai-32b yang serbaguna.", 
    ...
    "Informasi": [
        { 
            ...
            title: "Detik News", 
            status: "online", 
            description: "API untuk mendapatkan berita terbaru dari Detik.", 
        ...
        { 
            ...
            title: "Tahukah Kamu", 
            status: "online", 
            description: "API yang memberikan fakta-fakta menarik.", 
    ...
    "Lainnya": [
        { 
            ...
            title: "Cek Khodam", 
            status: "online", 
            description: "API untuk mengecek khodam.", 
        ...
        { 
            ...
            title: "Translate", 
            status: "online", 
            description: "API untuk menerjemahkan teks ke berbagai bahasa.", 
        ...
        { 
            ...
            title: "Nulis", 
            status: "online", 
            description: "API untuk menulis teks seperti tulisan tangan.", 
        ...
        { 
            ...
            title: "Quote Card", 
            status: "online", 
            description: "API untuk membuat quote card.", 
            endpoint: "/api/qc?text=" 
        },
        { 
            method: "GET", 
            title: "Screenshot Web", 
            status: "online", 
            description: "API untuk mengambil screenshot dari halaman web.", 
